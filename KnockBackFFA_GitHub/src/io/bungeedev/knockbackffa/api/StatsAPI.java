...
public class StatsAPI
{
  ...
  public static void addWin(String uuid, String name, Integer wins)
  {
    if (playerExists(uuid))
    {
  ...
  public static void addLose(String uuid, String name, Integer lose)
  {
    if (playerExists(uuid))
    {
      setLose(uuid, name, Integer.valueOf(getLoses(uuid, name).intValue() + lose.intValue()));
    }
    else
    {
      createPlayer(uuid, name);
  ...
  public static void removeWins(String uuid, String name, Integer wins)
  {
    if (playerExists(uuid))
    {
      setKills(uuid, name, Integer.valueOf(getKills(uuid, name).intValue() - wins.intValue()));
    }
    else
    {
      createPlayer(uuid, name);
      removeWins(uuid, name, wins);
    }
  }
